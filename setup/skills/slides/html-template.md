...
<head>
    ...
    <!-- Fonts: Google Fonts / Fontshare — never system fonts.
         DEFAULT = Aircall brand stack. A chosen creative preset/bold template swaps these. -->
    ...
    <style>
        /* ===========================================
           ...
           DEFAULT shown = Aircall Brand (see STYLE_PRESETS.md → "Aircall Brand"
           and aircall-brand.md). For internal Aircall decks keep these. For a
           creative/external deck, replace this whole :root with the chosen
           preset's tokens (and its font link above).
           =========================================== */
        :root {
            /* Colors — Aircall Brand (default) */
            ...
            --slide-bg: #FAFBFD;          /* used by viewport-base.css .slide/.deck-stage */
            --stage-bg: #011310;          /* letterbox bars — Neutral 900 */

            /* Typography — Aircall (authored at 1920×1080 stage size; never bold) */
